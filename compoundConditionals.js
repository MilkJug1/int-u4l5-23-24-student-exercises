...
let secretUsername = ("MuscleMan");
let secretPassword = ("MyMom");
...
button.addEventListener("click", function () {
    ...
    if (username == secretUsername && password == secretPassword) {
        message.innerHTML = "Success, you've logged in!";
    } else if (username === secretUsername && password != secretPassword) {
        message.innerHTML = "Incorrect Password";
    } else if (username !== secretUsername && password == secretPassword) {
        message.innerHTML = "Incorrect Username, might be a typo?"
    } else if (username == "" && password == "") {
        message.innerHTML = "Don't leave both options blank"
    }
    // CODE SOLO
